...
func NewBastion(ctx *pulumi.Context,
	...
	if args.SubnetNetworkId == nil {
		return nil, errors.New("invalid value for required argument 'SubnetNetworkId'")
	}
	opts = pkgResourceDefaultOpts(opts)
	var resource Bastion
	err := ctx.RegisterRemoteComponentResource("tailscale-bastion:gcp:Bastion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type bastionArgs struct {
	...
	SubnetNetworkId string `pulumi:"subnetNetworkId"`
}
...
type BastionArgs struct {
	...
	// The subnetwork to create the bastion in.
	SubnetNetworkId pulumi.StringInput
}
...
// The name of the autoscaler that manages the instances.
func (o BastionOutput) AutoscalerName() pulumi.StringOutput {
	return o.ApplyT(func(v *Bastion) pulumi.StringOutput { return v.AutoscalerName }).(pulumi.StringOutput)
}

// The name of the group manager that manages the instances.
func (o BastionOutput) GroupManagerName() pulumi.StringOutput {
	return o.ApplyT(func(v *Bastion) pulumi.StringOutput { return v.GroupManagerName }).(pulumi.StringOutput)
}
...
// The name of the target that manages the instances.
func (o BastionOutput) TargetPoolName() pulumi.StringOutput {
	return o.ApplyT(func(v *Bastion) pulumi.StringOutput { return v.TargetPoolName }).(pulumi.StringOutput)
}
