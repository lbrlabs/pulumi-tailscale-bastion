...
namespace Lbrlabs.PulumiPackage.TailscaleBastion
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Lbrlabs.PulumiPackage.TailscaleBastion.version.txt");
    ...
    internal sealed class TailscaleBastionResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TailscaleBastionResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
